...
abstract class CommonViewModel<INTENT : Any, STATE : Parcelable>(
    ...
    private fun apiExceptionHandle(responseCode: Int) {
        when (responseCode) {
            Constants.RESPONSE_CODE_400_BAD_REQUEST -> R.string.common_msg_error_bad_request
            Constants.RESPONSE_CODE_401_UNAUTHORIZED -> R.string.common_msg_error_unauthorized
            Constants.RESPONSE_CODE_403_FORBIDDEN -> R.string.common_msg_error_forbidden
            Constants.RESPONSE_CODE_404_NOT_FOUND -> R.string.common_msg_error_not_found
            Constants.RESPONSE_CODE_415_UNSUPPORTED_MEDIA_TYPE -> R.string.common_msg_error_unsupported_media_type
            Constants.RESPONSE_CODE_429_RATE_LIMIT_EXCEEDED -> R.string.common_msg_error_rate_limit_exceeded
            Constants.RESPONSE_CODE_500_INTERNAL_SERVER_ERROR -> R.string.common_msg_error_internal_server_error
            Constants.RESPONSE_CODE_503_SERVICE_UNAVAILABLE -> R.string.common_msg_error_service_unavailable
